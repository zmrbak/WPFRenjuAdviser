...
namespace RenjuAdvisor.Service
{
    public abstract class BaseConfiguration : IConfiguration
    {
        ...
        protected void Deconstruct(out int GameProcessId, out string GameUiTitle, out Size GameUiSize, out Point GameBoardPoint, out int GameBoardInsideWidth, out int CaptureInterval)
        {
