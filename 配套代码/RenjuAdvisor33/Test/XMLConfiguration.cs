        ...
        public override bool Load()
        {
            try
            {
                ...
                using (StringReader sr = new StringReader(xml))
                {
                    ...
                    //(GameProcessId, GameUiTitle, GameUiSize, GameBoardPoint, GameBoardInsideWidth) = a;

                    (GameProcessId, GameUiTitle, GameUiSize, GameBoardPoint, GameBoardInsideWidth) = xmlSerializer.Deserialize(sr) as XMLConfiguration;
